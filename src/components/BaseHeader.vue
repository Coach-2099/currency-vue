          ...
          <div class="header__body d-flex justify-content-between">
                ...
                <nav id="main-nav" class="main-nav">
                  <ul id="menu-primary-menu" class="menu">
                    ...
                    <li class="menu-item-has-children">
                      ...
                      <ul class="sub-menu">
                        <li class="menu-item">
                          <a href="#">Buy Crypto Select</a>
                        </li>
                        <li class="menu-item">
                          <a href="#">Buy Crypto Confirm</a>
                        </li>
                        <li class="menu-item">
                          <a href="#">Buy Crypto Details</a>
                        </li>
                      </ul>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item-has-children">
                      ...
                      <ul class="sub-menu">
                        <li class="menu-item">
                          <a href="#">Sell Select</a>
                        </li>
                        <li class="menu-item">
                          <a href="#">Sell Crypto Amount</a>
                        </li>
                        <li class="menu-item">
                          <a href="#">Sell Crypto Confirm</a>
                        </li>
                        <li class="menu-item">
                          <a href="#">Sell Crypto Details</a>
                        </li>
                      </ul>
                    </li>
                    <li class="menu-item-has-children">
                      ...
                      <ul class="sub-menu">
                        ...
                        <li class="menu-item">
                          <a href="#">Blog Grid v1</a>
                        </li>
                        <li class="menu-item">
                          <a href="#">Blog Grid v2</a>
                        </li>
                        <li class="menu-item">
                          <a href="#">Blog List</a>
                        </li>
            ...
            <div class="header__right">
              ...
              <div class="mode-switcher">
                <a class="sun" href="#" @click.prevent="toggleTheme" v-if="!isDarkMode">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                ...
                <a href="#" class="moon" @click.prevent="toggleTheme" v-else>
                  <svg
                    width="14"
                    height="14"
                    viewBox="0 0 14 14"
              ...
              <div class="mobile-button" @click="toggleMobileMenu">
                <span></span>
              </div>
              <div class="wallet">
                <a href="#">Wallet</a>
