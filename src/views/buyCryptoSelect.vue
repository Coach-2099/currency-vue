        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <div class="content-tab">
              <div v-if="projectType === 1" class="content-inner buy-crypto__main">
                <div class="top">
                  <ul class="top-list">
                    <li class="active">
                ...
                <div class="main">
                  ...
                  <form action="buy-crypto-confirm.html" class="form">
              ...
              <div v-if="projectType === 2" class="content-inner buy-crypto__main">
                <div class="top">
                  <ul class="top-list">
                    <li class="active">
                      <h6><span></span>Select currency</h6>
              ...
              <div v-if="projectType === 3" class="content-inner buy-crypto__main">
                <div class="top">
                  <ul class="top-list">
                    <li class="active">
                      <h6><span></span>Select currency</h6>
