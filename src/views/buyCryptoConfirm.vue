            ...
            <div class="content-tab">
              <div class="content-inner buy-crypto__main">
                ...
                <div class="main info">
                  ...
                  <p class="desc">You are about to Receive 1.356 BTC for Bitcloud bank</p>
                ...
                <div class="main details">
                  ...
                  <form action="buy-crypto-details.html">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" value="Veum Cecilia" />
                    </div>
                    <div class="form-group">
                      <label>Account number</label>
                      <input class="form-control" type="text" value="V548422222221" />
                    </div>
                    <div class="form-group">
                      <label>Address</label>
                      <input class="form-control" type="text" value="079 Dariana Knoll, CA" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" value="55416 Powlowski Spring, CA" />
                    </div>

                    <div class="code">
                      <h6>Reference code</h6>
                      <p class="mb-5">
                        You MUST include the Reference Code in your deposit in order to credit your
                        account!
                      </p>
                      <p>Reference Code:</p>
