      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-3 col-md-12">
            ...
            <ul class="menu-tab">
              <li :class="projectType === 1 ? 'active' : ''" @click="checkProject(1)">
                <h6 class="fs-16">
                  <svg
                    width="20"
                    height="24"
              ...
              <li :class="projectType === 2 ? 'active' : ''" @click="checkProject(2)">
                <h6 class="fs-16">
                  <svg
                    width="21"
                    height="22"
              ...
              <li :class="projectType === 3 ? 'active' : ''" @click="checkProject(3)">
                <h6 class="fs-16">
                  <svg
                    width="24"
                    height="24"
              ...
              <li :class="projectType === 4 ? 'active' : ''" @click="checkProject(4)">
                <h6 class="fs-16">
                  <svg
                    width="24"
                    height="20"
              ...
              <li :class="projectType === 5 ? 'active' : ''" @click="checkProject(5)">
                <h6 class="fs-16">
                  <svg
                    width="20"
                    height="24"
          ...
          <div class="col-lg-9">
            <div class="content-tab">
              <div v-if="projectType === 1" class="content-inner profile">
                <form @submit.prevent="updateProfile">
                  ...
                  <div class="form-group d-flex">
                    ...
                    />
                    <div class="sl">
                      <select v-model="profile.countryCode" class="form-control">
                        <option v-for="code in countryCodes" :value="code" :key="code">
                          {{ code }}
                        </option>
                      </select>
                      <input
                  ...
                  <div class="form-group d-flex">
                    <select v-model="profile.nationality" class="form-control">
                      <option v-for="nation in nationalities" :value="nation" :key="nation">
                        {{ nation }}
                      </option>
                    </select>
                    <div class="sl">
                      <select v-model="profile.gender" class="form-control gt">
                  ...
                  <h6 class="two">功能设置</h6>
                  <div class="bt d-flex">
                    <div class="left">
                      <h6>等级 1</h6>
                      <ul>
                        <li v-for="(feature, index) in level1Features" :key="index">
                          <p>{{ feature.label }}</p>
                          <label class="switch">
                            <input
                          ...
                          <p v-if="feature.description" class="text">{{ feature.description }}</p>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div v-if="projectType === 2" class="content-inner referrals">
                <h6>Total rewards</h6>
              ...
              <div v-if="projectType === 3" class="content-inner api">
                ...
                <div class="main">
                  ...
                  <div class="refe">
                    <div class="form-group">
                      <p>Your Password</p>
                      <input class="form-control" type="password" placeholder="Passworld" />
                    </div>
                    <div class="form-group">
                      <p>2FA Code</p>
              ...
              <div v-if="projectType === 4" class="content-inner api">
                <h4>2FA <span class="color-success">Enabled</span></h4>
                <p>
                  If you want to turn off 2FA, input your account password and the six-digit code
                  provided by the Google Authenticator app below, then click
                  <strong>"Disable 2FA"</strong>.
                </p>

                <div class="main">
                  <h6>Disable 2FA</h6>
                  <p>Enter your password and 2FA code to Disable the 2FA verification</p>
              ...
              <div v-if="projectType === 5" class="content-inner profile change-pass">
                ...
                <form action="#">
                  ...
                  <div class="form-group">
                    <div>
                      ...
                      <input type="password" class="form-control" placeholder="New Passworld" />
                    </div>
                    <div>
                      <label>Confirm Passworld<span>*</span>:</label>
                      <input type="password" class="form-control" placeholder="Confirm Passworld" />
                    </div>
                  </div>
                </form>
                <button type="submit" class="btn-action">Change Passworld</button>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      countryCodes: ['+1', '+84', '+82', '+32'],
      nationalities: ['South Korean', 'Vietnamese'],
      level1Features: [
        { label: '资产存入', enabled: true, disabled: false },
        {
          label: '资产提取',
          enabled: true,
          disabled: true,
          description: '已启用 $1,000,000/天',
        },
        // 其他功能项...
      ],
      saving: false,

      projectType: 1, // 1: User Profile, 2: Referrals, 3: API keys, 4.2FA, 5.Change password
    }
  },
  created() {
  ...
  methods: {
    ...
    async updateProfile() {
      ...
      try {
        ...
        this.$notify({ type: 'success', message: '资料更新成功' })
      } catch (error) {
